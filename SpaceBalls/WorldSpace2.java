 ...
 */
public class WorldSpace2 extends Mundo
{
       private int dead=0;
       private int dead2=0;
       private int dead3=0;
       ...
       EnemyF2 eF2=new EnemyF2();
       WorldSpace wS=new WorldSpace();
    ...
    {    
       ...
       showText("Nivel: 2",450,15);
    }
  
    public void act(){
       imprime();
       int f1=dead+dead2+dead3;
       //int f1=10;
       if(puntos()==1)
          puntos+=10;
       ...
       if(f1==10&&bandf==0)
          addObject(eF2,600,250);
       
       if(tocadoF2()==1)
          bf1++;
       if(bandf==1)
          Greenfoot.setWorld(new WorldSpace3());
    }
